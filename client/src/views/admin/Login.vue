<template>
    <section class="admin-login w-full min-h-[100vh] flex justify-center items-center relative text-[#606266] text-[1.4rem] overflow-hidden">
...
const { login, setRememberStatus } = useAdminStore();
const { isLoginFailed, message } = storeToRefs(useAdminStore());
